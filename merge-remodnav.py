"""
Script to combine all remodnav output files to one file, which can be imported into your statistics software
"""
...
json_to_combine = glob.glob(f"{__constants.output_folder}/*/*/*/*_{batch_id}_agg.json")
...
# export df
output_file_name = '{}/merged_remodnav_{}.csv'.format(__constants.output_folder, batch_id)
df.to_csv(output_file_name)

print("Done! {} files combined to merged_remodnav_{}.csv".format(len(json_to_combine), batch_id))
...
# export df wide
output_file_name = '{}/merged_remodnav_wide_{}.csv'.format(__constants.output_folder, batch_id)
df_wide.to_csv(output_file_name)

print("Done! {} participants combined to merged_remodnav_wide_{}.csv".format(len(participants), batch_id))